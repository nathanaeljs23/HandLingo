  ...
  const sections = [
    {
      ...
      icon: User,
      items: [
        { label: "Username", value: "learner_42", type: "text" as const },
        { label: "Email", value: "learner@example.com", type: "text" as const },
        { label: "Current Level", value: "Level 2", type: "badge" as const },
      ],
    },
    {
      title: "Camera & Input",
                      ...
                      {item.type === "toggle" && (
                        <div
                          className={`w-10 h-6 rounded-full flex items-center px-1 cursor-pointer transition-colors ${
                            item.value === "On" ? "bg-primary" : "bg-muted"
                          }`}
                        >
                          <div
